...
const Sidebar = ({ activeTab, setActiveTab }) => {
  ...
  const navItems = [
    ...
    { id: "users", icon: UserRoundCog, label: "Users", link: "/users" },
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 h-screen w-20 bg-gray-950/95 backdrop-blur-sm flex flex-col items-center border-r border-gray-800/50 z-50">
        ...
        <div className="pb-8 px-2">
          ...
          >
            ...
            <span className="text-xs font-medium tracking-tight">{logoutItem.label}</span>
          </button>
        </div>
